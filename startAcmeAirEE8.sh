podman run -d --rm --cpus=1.0 -m=512m --network=slirp4netns -e JVM_ARGS='' -e MONGO_HOST="9.46.81.11" -e MONGO_PORT=27017 -e MONGO_DBNAME=acmeair -p 9080:9080 --name lib1 localhost/liberty-acmeair-ee8:23.0.0.6
